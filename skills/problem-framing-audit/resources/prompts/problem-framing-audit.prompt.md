...
Run the step-back protocol on a non-trivial problem before committing to a solution. The most expensive class of error is solving the wrong problem precisely (Type III error). The bundled [`problem-framing-audit.instructions.md`](../instructions/problem-framing-audit.instructions.md) provides supporting context; this prompt guides a deliberate audit when the work earns it.

Skill: [problem-framing-audit](../../SKILL.md). Always-on rule: [problem-framing-audit.instructions.md](../instructions/problem-framing-audit.instructions.md).
