...
description: >-
  Step-back protocol — restate, generalise, specialise, invert, ask why, pre-mortem, check
  stakeholders, and audit framings before solving
---
...
| [`critical-thinking.instructions.md`](../critical-thinking/resources/instructions/critical-thinking.instructions.md) | Provides supporting context: *"Before solving non-trivially, restate the problem in one sentence; if user's framing differs from yours, flag it before proceeding."* |
| [`act-pass.instructions.md`](../act-tenets/resources/instructions/act-pass.instructions.md) | Step 1 of the 7-step pass *is* the frame audit |
| [`problem-framing-audit.prompt.md`](resources/prompts/problem-framing-audit.prompt.md) | Focused workflow for a stuck problem |

## Background Reading

- CRITICAL-THINKING-FAILURE-MODES — the master failure mode and step-back protocol
...
- resources/instructions/problem-framing-audit.instructions.md
- resources/prompts/problem-framing-audit.prompt.md
