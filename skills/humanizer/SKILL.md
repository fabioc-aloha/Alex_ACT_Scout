...
name: humanizer
description: >-
  Use when the user wants to humanize, de-AI, de-slop, or un-ChatGPT a piece of text — strip
  AI-isms and add real voice. Scans for 29 documented AI-writing patterns (Wikipedia's "Signs of
  AI writing") and produces a draft → self-audit → final rewrite. Optional voice-calibration from
  a user-provided writing sample. Adapted from Hermes Agent / blader/humanizer.
---
...
- [communication-craft](../communication-craft/SKILL.md) — use when the issue is audience fit, feedback framing, or stakeholder communication rather than AI-tell removal
...
- **Date-based**: 2026-11-30 (v2.0.1 tester-feedback window). If by then `humanizer` is invoked but consistently overrides tester voice in ways they revert ≥3 times, the Voice Calibration section is failing — either tighten the calibration discipline or rebalance toward voice-preserving rewrites.
