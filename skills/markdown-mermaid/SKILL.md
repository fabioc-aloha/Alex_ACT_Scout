...
description: >-
  Author Mermaid diagrams that render correctly in GitHub, VS Code, and Mermaid 10+ consumers.
  Applies a config-driven init directive + linkStyle + semantic classDef vocabulary from
  `.github/config/brand-palette.json` (default: 6-role semantic palette + typography). Covers
  renderer pitfalls, mode fragility, and diagram-tool selection. Use when embedding Mermaid in
  markdown, debugging silent render failures, or choosing between Mermaid / Excalidraw / D2 /
  PlantUML.
---
