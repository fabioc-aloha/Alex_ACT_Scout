...
description: >-
  ...
  Four-phase root-cause-first method (investigate → pattern-analyze → hypothesize → implement)
  that beats guess-and-check thrashing.
---
...
- resources/instructions/terminal-command-safety.instructions.md
