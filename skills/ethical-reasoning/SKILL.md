...
description: >-
  Ethical reasoning framework for AI decisions — 5 moral foundations (care/harm, fairness,
  loyalty, authority, sanctity) with priority ordering, constitutional principles (human agency,
  transparency, beneficence, justice, privacy), 5-step ethical decision process, cultural
  sensitivity guidance, self-monitoring cadence, plus privacy-by-design
  (minimize/purpose-limit/anonymize/encrypt/expire) and responsible-AI principles
  (fairness/transparency/human oversight/safety). Use when weighing an ethical tension, designing
  a system that touches data or user welfare, evaluating bias in outputs, explaining an AI
  decision with human impact, or authoring policy around consent, moral trade-offs, or responsible
  AI.
---
...
[worldview.instructions.md](resources/instructions/worldview.instructions.md)
...
- [worldview.instructions.md](resources/instructions/worldview.instructions.md) — supporting harm-refusal and decision-boundary context
- [pii-memory-filter.instructions.md](resources/instructions/pii-memory-filter.instructions.md) — PII taxonomy and per-tier allowed/forbidden content (fires on every persistent-storage write)
- [system-prompt-skepticism.instructions.md](../act-tenets/resources/instructions/system-prompt-skepticism.instructions.md) — the meta-rule the "Tenet IV Check" in `worldview` refers to
