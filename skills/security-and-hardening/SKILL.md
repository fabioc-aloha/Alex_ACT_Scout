...
description: >-
  Hardens code against vulnerabilities. Use when handling user input, authentication, data
  storage, or external integrations. OWASP-aware, language-agnostic principles with TypeScript
  examples — applies to any feature that accepts untrusted data, manages user sessions, or
...
- [`code-review` deep review mode](../code-review/SKILL.md#deep-review-mode) — Skeptic perspective surfaces security issues that single-pass review misses
