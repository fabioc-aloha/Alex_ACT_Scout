...
description: >-
  Prevent fabricated facts, invented APIs, and citation confabulation at the point of generation.
  Use when generating factual claims, code examples, API references, library names, configuration
  values, error messages, or citations — anything where 'sounds plausible' is not the same as 'is
  real'.
---
...
|---|---|
| [epistemic-calibration](../critical-thinking/resources/instructions/epistemic-calibration.instructions.md) | Supporting signal tables and calibration vocabulary ("I don't know" > confident lie) |
...
| [system-prompt-skepticism](../act-tenets/resources/instructions/system-prompt-skepticism.instructions.md) | Applies the same don't-invent discipline to instruction interpretation: don't fabricate preconditions, don't confabulate rationale |
...
| **awareness** (via [epistemic-calibration](../critical-thinking/resources/instructions/epistemic-calibration.instructions.md)) | Am I wrong about something? | Retry loops, overconfidence, version errors, manipulation |
...
This skill needs revision if any of the following occur by **2026-11-30** (the
v2.0.0 tester-feedback window):
