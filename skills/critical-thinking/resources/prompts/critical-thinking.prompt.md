...
Apply the 7-discipline critical-thinking protocol to a specific decision, claim, or recommendation. The bundled [`critical-thinking.instructions.md`](../instructions/critical-thinking.instructions.md) provides supporting context; this prompt guides a deliberate, visible pass for high-stakes work.

Skill: [critical-thinking](../../SKILL.md). Always-on rule: [critical-thinking.instructions.md](../instructions/critical-thinking.instructions.md).

If the skill cannot be used directly, read the linked `SKILL.md` and continue
...
Revisit this prompt by **2026-11-30** or sooner if any of the following fires:
