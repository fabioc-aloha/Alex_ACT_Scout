...
description: >-
  Challenge what you think is right — alternative hypotheses, missing data, evidence quality, bias
...
Use this skill at decision points, with intensity proportional to the stakes:
...
| User asks to run `problem-framing-audit` or asks "what am I missing?"                                                        | **Run**     |
...
> **Detailed body**: Full step-back protocol with worked examples, stakeholder-check templates, and falsifiability test → [`problem-framing-audit/SKILL.md`](../problem-framing-audit/SKILL.md). Supporting context → [`problem-framing-audit.instructions.md`](../problem-framing-audit/resources/instructions/problem-framing-audit.instructions.md). Focused workflow → [`problem-framing-audit.prompt.md`](../problem-framing-audit/resources/prompts/problem-framing-audit.prompt.md).
...
- resources/instructions/critical-thinking.instructions.md
- resources/instructions/epistemic-calibration.instructions.md
- resources/prompts/critical-thinking.prompt.md
