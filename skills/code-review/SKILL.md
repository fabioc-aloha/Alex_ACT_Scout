...
1. Gather context: diff, related files, tests, and recent history for changed modules.
2. Run Advocate, Skeptic, and Architect perspectives independently.
3. Synthesize agreements as high-confidence findings.
4. Resolve conflicts with evidence: `file:line` citations beat assertions.
5. Mark unresolved disagreements as disputed for human decision.
